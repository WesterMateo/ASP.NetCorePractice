...
namespace InventorySystem.Aplication.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImporteFactura = table.Column<decimal>(type: "decimal(12,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID_FacturaLinea = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ID_Factura = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ID_Articulo = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Descripcion = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Cantidad = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FacturaLinea", x => x.ID_FacturaLinea);
                });
